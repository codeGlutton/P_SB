...
DECLARE_DELEGATE_RetVal_OneParam(float, FGetVelocityDelegate, const Protocol::MoveState)
...
public:	
	...
	void													AddInitMoveRecord(const Protocol::PosInfo& PosInfo, const Protocol::MoveState& State);
...
public:
	FGetVelocityDelegate									PredictedVelocityDelegate;
