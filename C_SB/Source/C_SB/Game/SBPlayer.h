...
public:
	...
	const TObjectPtr<class USBMovementComponent>	GetSBMovement();
...
private:
	UPROPERTY(Category = "SBMovement", VisibleAnywhere, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	TObjectPtr<class USBMovementComponent>			_SBMovement;
};