...
private:
	...
	static void									RecvReqCheckExistsAccount(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful);
	static void									RecvReqCreateAccount(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful);
	static void									RecvReqLoginAccount(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful);
