...
COPY /Y HttpProtocol.pb.h "../../../S_SB"
COPY /Y HttpProtocol.pb.cc "../../../S_SB"
...
COPY /Y RedisProtocol.pb.h "../../../../C_SB/Source/C_SB/Protocol"
COPY /Y RedisProtocol.pb.cc "../../../../C_SB/Source/C_SB/Protocol"
...
COPY /Y Protocol.cs "../../../../W_SB/WS_SB/Protobuf"
